 ...
 */
@Service
class SnsClientSubSystemFacadeImpl : SnsClientSubSystemFacade{
     ...
     */
    override fun createTopic(topicRequest: CreateTopicRequest, snsClient: SnsClient) : CreateTopicResponse {
     ...
     * @return listTopics
     */
    override fun getAllTopicsAsList(listTopicRequest: ListTopicsRequest, snsClient: SnsClient): ListTopicsResponse {
     ...
     */
    override fun isAlreadyConfirm(confirmSubscriptionRequest: ConfirmSubscriptionRequest, snsClient: SnsClient) : String {
